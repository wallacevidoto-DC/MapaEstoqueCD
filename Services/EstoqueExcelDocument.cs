...
{
    internal class EstoqueExcelDocument
    {
        ...
        public EstoqueExcelDocument(List<EstoqueWsDto> produtos)
        {
            this.produtos = produtos ?? new List<EstoqueWsDto>();
        }
